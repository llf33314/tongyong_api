...
public class DateTimeKitUtils {
	...
	public static String getDay() {
		String day = "";
		int d = DateTimeKitUtils.getNow().getDay();
		if (d == 0) {
			day = "星期日";
		} else if (d == 1) {
			day = "星期一";
	...
	public static long[] getDistanceTimes(String str1, String str2) {
		...
		long sec = 0;
		try {
			if (CharacterUtils.isEmpty(str1) || CharacterUtils.isEmpty(str2)) {
				return null;
			}
			one = df.parse(str1);
			two = df.parse(str2);
	...
	public static Long getStartTime(){  
		...
		System.out.println(DateTimeKitUtils.format(currentTime, yyyyMMddHHmmssms));
	...
	public static Long getStartTime(Date date){  
		...
		date.setMinutes(0);
		date.setSeconds(0);
		System.out.println(DateTimeKitUtils.format(date, yyyyMMddHHmmssms));
	...
	public static Long getEndTime(){  
		...
		System.out.println(DateTimeKitUtils.format(backupTime, yyyyMMddHHmmssms));
	...
	public static long timeBetween(String date_str,String format,String date_str1,String format1,long mill){
		long result=0 ;
		try {  
			long l =  DateTimeKitUtils.date2TimeStamp(date_str,format);
			long l1 =  DateTimeKitUtils.date2TimeStamp(date_str1,format1);
			if(l>l1){
				result =  (l-l1)/mill;
			}else{
				result =  (l1-l)/mill;
