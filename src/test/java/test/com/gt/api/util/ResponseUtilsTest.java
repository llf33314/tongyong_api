...
public class ResponseUtilsTest {
	...
	LOGGER.info( "成功数据格式+定制状态码+定制消息+返回泛型数据：{}",
			om.writeValueAsString( ResponseUtils.createBySuccessCodeMessage( ResponseEnums.SUCCESS.getCode(), ResponseEnums.SUCCESS.getDesc(), "XXXUser" ) ) );
	...
	LOGGER.info( "失败数据格式+定制状态码+定制消息：{}", om.writeValueAsString( ResponseUtils.createByErrorCodeMessage( ResponseEnums.SYSTEM_ERROR.getCode(), ResponseEnums.SYSTEM_ERROR.getDesc() ) ) );
    }
